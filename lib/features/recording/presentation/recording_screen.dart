          ...
          children: [
            ...
            child: Column(
              children: [
                // 0. 顶部导航
                Padding(
                  padding: const EdgeInsets.fromLTRB(20, 10, 16, 8), // 从 4 增加回 8，平衡间距
                  child: Row(
                    children: [
                      Expanded(
                        child: Text(
                      ...
                      IconButton(
                        ...
                        icon: Icon(Icons.settings, color: Theme.of(context).colorScheme.onSurface, size: 22),
                        style: IconButton.styleFrom(
                          backgroundColor: Theme.of(context).colorScheme.surfaceVariant.withOpacity(Theme.of(context).brightness == Brightness.dark ? 0.3 : 0.1), // 白天模式下降低背景深度
                      ...
                      IconButton(
                        ...
                        icon: Icon(Icons.history, color: Theme.of(context).colorScheme.onSurface, size: 22),
                        style: IconButton.styleFrom(
                          backgroundColor: Theme.of(context).colorScheme.surfaceVariant.withOpacity(Theme.of(context).brightness == Brightness.dark ? 0.3 : 0.1), // 同上
                          padding: const EdgeInsets.all(10),
                        ),
                      ),
                    ],
                ...
                Expanded(
                  child: LayoutBuilder(
                    builder: (context, constraints) {
                      return Container(
                        margin: const EdgeInsets.fromLTRB(16, 4, 16, 12), // 顶部间距从 0 增加回 4
                ...
                // 2. 监控区 (调整高度比例和内边距)
                Container(
                  height: MediaQuery.of(context).size.height * 0.23, // 稍微压缩高度从 0.25 到 0.23
                    ...
                    children: [
                      ...
                      sensorDataAsync.maybeWhen(
                        data: (data) => GForceBall(
                          ...
                          size: MediaQuery.of(context).size.width * 0.35, // 缩小尺寸从 0.4 到 0.35
                        ),
                        orElse: () => Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            SensorWaveform(
                              ...
                              color: Theme.of(context).colorScheme.primary, // 使用主题绿色，解决过暗问题
                              label: i18n.t('longitudinal'),
                            ),
                            const Spacer(),
                            SensorWaveform(
                              data: _accelXHistory.toList(), 
                              color: Theme.of(context).colorScheme.secondary, // 使用主题蓝色
                          ...
                          child: Row(
                            ...
                            children: [
                              _RecordingStat(
                                ...
                                value: "${(recordingState.currentDistance / 1000).toStringAsFixed(2)} km",
                                icon: Icons.straighten,
                              ),
                              _RecordingStat(
                                label: i18n.t('peak_g'), 
                                value: "${recordingState.maxGForce.toStringAsFixed(2)}G",
                                icon: Icons.shutter_speed,
                              ),
                              // 各类事件分类计数
                              ..._buildEventBreakdown(recordingState.events, context),
                            ],
                          ),
                        ),
                        GridView.count(
                          ...
                          children: [
                            _TagButton(
                              ...
                              onPressed: () {
                                ref.read(recordingProvider.notifier).tagEvent(EventType.rapidAcceleration);
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(content: Text(i18n.t('recorded_msg')), duration: const Duration(seconds: 1)),
                                );
                              },
                            ),
                            _TagButton(
                              ...
                              onPressed: () {
                                ref.read(recordingProvider.notifier).tagEvent(EventType.rapidDeceleration);
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(content: Text(i18n.t('recorded_msg')), duration: const Duration(seconds: 1)),
                                );
                              },
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(i18n.t('calibration_tip'), style: TextStyle(color: Colors.white.withOpacity(0.6), fontSize: 14)),
                  ],
                ),
              ),
            ),
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                label, 
                style: TextStyle(
                  color: isDarkMode ? color.withOpacity(0.9) : color.withAlpha(200),
