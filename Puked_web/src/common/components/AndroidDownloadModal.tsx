...
const AndroidDownloadModal: React.FC<AndroidDownloadModalProps> = ({
  isOpen,
  onClose,
  version,
  directDownloadUrl,
  ...
  const downloadSources = [
    ...
    },
    {
      ...
      url: 'https://github.com/hkgood/Puked/releases',
      icon: Github,
        ...
        >
          ...
          <div className="relative px-8 pt-8 pb-4 border-b border-gray-100">
            ...
            <h2 className="text-2xl font-black text-[#1D1D1F] mb-1">
              {t('download_android_title')}
            </h2>
            <p className="text-sm text-gray-500 font-medium">
              {t('download_android_subtitle')} · v{version}
            </p>
          </div>
