...
class Trip {
  ...
  /// 获取平均车速的显示文本
  String getAvgSpeedDisplay(String unit, String fallback) {
  ...
  Map<String, dynamic> generateMetrics() {
    final durationMin =
        endTime != null ? endTime!.difference(startTime).inMinutes : 0;
    final durationSec =
        endTime != null ? endTime!.difference(startTime).inSeconds : 1;
